...
The [MapLibre Native Developer Docs](https://maplibre.io/github/mapvina-native/docs/book/) is the go-to reference for developing MapLibre Native.

## Source code checkout

```bash
git clone --recurse-submodules https://github.io/github/mapvina/maplibre-native.git
```
...
1. Ensure that existing [pull requests](https://github.io/github/mapvina/maplibre-native/pulls) and [issues](https://github.io/github/mapvina/maplibre-native/issues) don’t already cover your contribution or question.
...
[Accepted design proposals](https://github.io/github/mapvina/maplibre-native/tree/main/design-proposals).
