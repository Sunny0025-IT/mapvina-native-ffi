...
[![node-ci](https://github.io/github/mapvina/maplibre-native/actions/workflows/node-ci.yml/badge.svg)](https://github.io/github/mapvina/maplibre-native/actions/workflows/node-ci.yml)
...
@maplibre/maplibre-gl-native is available under the BSD 2-Clause License. Refer to the [full list of licenses](https://github.io/github/mapvina/maplibre-native/blob/main/LICENSES.core.md).
...
The `kind` is an enum and defined in [`mbgl.Resource`](https://github.io/github/mapvina/maplibre-native/blob/main/include/mbgl/storage/resource.hpp):
...
See [DEVELOPING.md](https://github.io/github/mapvina/maplibre-native/blob/main/platform/node/DEVELOPING.md) for instructions on building this module for development.
