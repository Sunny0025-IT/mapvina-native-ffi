...
2. Add the library as a dependency into your module Gradle file (usually `<project>/<app-module>/build.gradle`). Replace `<version>` with the [latest MapLibre Android version](https://github.io/github/mapvina/maplibre-native/releases?q=android-v11&expanded=true) (e.g.: `io.github.mapvina.gl:android-sdk:11.8.0`):

    ```gradle
    dependencies {
        ...
        implementation 'io.github.mapvina.gl:android-sdk:<version>'
