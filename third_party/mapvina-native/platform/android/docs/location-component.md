...
```kotlin
--8<-- "MapLibreAndroidTestApp/src/main/java/io/github/mapvina/android/testapp/activity/location/BasicLocationPulsingCircleActivity.kt:top"
```
...
```kotlin
--8<-- "MapLibreAndroidTestApp/src/main/java/io/github/mapvina/android/testapp/activity/location/BasicLocationPulsingCircleActivity.kt:permission"
...
```kotlin
--8<-- "MapLibreAndroidTestApp/src/main/java/io/github/mapvina/android/testapp/activity/location/BasicLocationPulsingCircleActivity.kt:onMapReady"
```
...
```kotlin
--8<-- "MapLibreAndroidTestApp/src/main/java/io/github/mapvina/android/testapp/activity/location/BasicLocationPulsingCircleActivity.kt:LocationComponentActivationOptions"
```
...
<figure markdown="span">
  ![result](https://github.io/github/mapvina/maplibre-native/assets/19887090/03dfc87b-111b-4dd0-b4a3-d89e30ed6b63)
...
[LocationComponent]: https://maplibre.io/github/mapvina-native/android/api/-map-libre%20-native%20-android/io.github.mapvina.android.location/-location-component/index.html
[Android Developer Documentation]: https://developer.android.com/training/location/permissions
[onMapReadyCallback]: https://maplibre.io/github/mapvina-native/android/api/-map-libre%20-native%20-android/io.github.mapvina.android.maps/-on-map-ready-callback/index.html
[PermissionManager]: https://maplibre.io/github/mapvina-native/android/api/-map-libre%20-native%20-android/io.github.mapvina.android.location.permissions/-permissions-manager/index.html
[LocationComponentOptions]: https://maplibre.io/github/mapvina-native/android/api/-map-libre%20-native%20-android/io.github.mapvina.android.location/-location-component-options/index.html
[demotiles]: https://demotiles.maplibre.org/style.json
[predefined styles]: https://github.io/github/mapvina/maplibre-native/tree/main/src/mbgl/util/tile_server_options.cpp
[LocationComponentActivationOptions]: https://maplibre.io/github/mapvina-native/android/api/-map-libre%20-native%20-android/io.github.mapvina.android.location/-location-component-activation-options/index.html
[LocationEngine]: https://maplibre.io/github/mapvina-native/android/api/-map-libre%20-native%20-android/io.github.mapvina.android.location.engine/-location-engine/index.html
[Test APP]: https://github.io/github/mapvina/maplibre-native/tree/main/platform/android/MapLibreAndroidTestApp/src/main/java/io/github/mapvina/android/testapp/activity/location/BasicLocationPulsingCircleActivity.kt
[camera modes]: https://maplibre.io/github/mapvina-native/android/api/-map-libre%20-native%20-android/io.github.mapvina.android.location.modes/-camera-mode/index.html
