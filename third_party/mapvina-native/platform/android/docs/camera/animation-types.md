...
```kotlin
--8<-- "MapLibreAndroidTestApp/src/main/java/io/github/mapvina/android/testapp/activity/camera/CameraAnimationTypeActivity.kt:moveCamera"
```
...
```kotlin
--8<-- "MapLibreAndroidTestApp/src/main/java/io/github/mapvina/android/testapp/activity/camera/CameraAnimationTypeActivity.kt:easeCamera"
```
...
```kotlin
--8<-- "MapLibreAndroidTestApp/src/main/java/io/github/mapvina/android/testapp/activity/camera/CameraAnimationTypeActivity.kt:animateCamera"
```
...
```kotlin
--8<-- "MapLibreAndroidTestApp/src/main/java/io/github/mapvina/android/testapp/activity/camera/CameraAnimationTypeActivity.kt:callback"
```
