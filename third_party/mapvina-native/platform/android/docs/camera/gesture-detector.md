...
The gesture detector of MapLibre Android is encapsulated in the [`maplibre-gestures-android`](https://github.io/github/mapvina/maplibre-gestures-android) package.
...
```kotlin
--8<-- "MapLibreAndroidTestApp/src/main/java/io/github/mapvina/android/testapp/activity/camera/GestureDetectorActivity.kt:addOnMoveListener"
```
...
--8<-- "MapLibreAndroidTestApp/src/main/java/io/github/mapvina/android/testapp/activity/camera/GestureDetectorActivity.kt"
```
