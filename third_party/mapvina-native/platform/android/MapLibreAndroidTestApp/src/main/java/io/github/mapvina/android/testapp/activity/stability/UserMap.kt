...
import io.github.mapvina.android.annotations.IconFactory
...
class UserMap : SupportMapFragment() {
    ...
    companion object {
        ...
        // true -> use all bitmap drawables in `io.github.mapvina.android.R.drawable.*`
        private const val USE_ALL_DRAWABLES = false
        private val ICONS = arrayListOf(
            io.github.mapvina.android.R.drawable.maplibre_info_icon_default,
            io.github.mapvina.android.R.drawable.maplibre_user_icon,
            io.github.mapvina.android.R.drawable.maplibre_marker_icon_default,
            io.github.mapvina.android.R.drawable.maplibre_compass_icon,
            io.github.mapvina.android.R.drawable.maplibre_user_puck_icon,
        )
    ...
    private fun run() {
        if (USE_ALL_DRAWABLES) {
            bitmapDrawables =
                io.github.mapvina.android.R.drawable::class.java.fields.map { field: Field ->
