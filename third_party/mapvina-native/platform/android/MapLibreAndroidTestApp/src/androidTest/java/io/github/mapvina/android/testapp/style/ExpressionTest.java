...
import io.github.mapvina.android.style.types.Formatted;
import io.github.mapvina.android.style.types.FormattedSection;
import io.github.mapvina.android.testapp.R;
import io.github.mapvina.android.testapp.activity.EspressoTest;
import io.github.mapvina.android.testapp.utils.ResourceUtils;
...
import static io.github.mapvina.android.style.expressions.Expression.FormatOption.formatFontScale;
import static io.github.mapvina.android.style.expressions.Expression.FormatOption.formatTextColor;
import static io.github.mapvina.android.style.expressions.Expression.FormatOption.formatTextFont;
import static io.github.mapvina.android.style.expressions.Expression.NumberFormatOption.currency;
import static io.github.mapvina.android.style.expressions.Expression.NumberFormatOption.locale;
import static io.github.mapvina.android.style.expressions.Expression.NumberFormatOption.maxFractionDigits;
import static io.github.mapvina.android.style.expressions.Expression.NumberFormatOption.minFractionDigits;
import static io.github.mapvina.android.style.expressions.Expression.collator;
import static io.github.mapvina.android.style.expressions.Expression.color;
import static io.github.mapvina.android.style.expressions.Expression.eq;
import static io.github.mapvina.android.style.expressions.Expression.exponential;
import static io.github.mapvina.android.style.expressions.Expression.format;
import static io.github.mapvina.android.style.expressions.Expression.formatEntry;
import static io.github.mapvina.android.style.expressions.Expression.get;
import static io.github.mapvina.android.style.expressions.Expression.interpolate;
import static io.github.mapvina.android.style.expressions.Expression.literal;
import static io.github.mapvina.android.style.expressions.Expression.match;
import static io.github.mapvina.android.style.expressions.Expression.number;
import static io.github.mapvina.android.style.expressions.Expression.numberFormat;
import static io.github.mapvina.android.style.expressions.Expression.rgb;
import static io.github.mapvina.android.style.expressions.Expression.rgba;
import static io.github.mapvina.android.style.expressions.Expression.step;
import static io.github.mapvina.android.style.expressions.Expression.stop;
import static io.github.mapvina.android.style.expressions.Expression.string;
import static io.github.mapvina.android.style.expressions.Expression.switchCase;
import static io.github.mapvina.android.style.expressions.Expression.toColor;
import static io.github.mapvina.android.style.expressions.Expression.toPadding;
import static io.github.mapvina.android.style.expressions.Expression.zoom;
import static io.github.mapvina.android.style.layers.PropertyFactory.circleColor;
import static io.github.mapvina.android.style.layers.PropertyFactory.fillAntialias;
import static io.github.mapvina.android.style.layers.PropertyFactory.fillColor;
import static io.github.mapvina.android.style.layers.PropertyFactory.fillOutlineColor;
import static io.github.mapvina.android.style.layers.PropertyFactory.iconPadding;
import static io.github.mapvina.android.style.layers.PropertyFactory.textColor;
import static io.github.mapvina.android.style.layers.PropertyFactory.textField;
...
public class ExpressionTest extends EspressoTest {
  ...
  @Test
  @Ignore("https://github.io/github/mapvina/maplibre-native/issues/2437")
