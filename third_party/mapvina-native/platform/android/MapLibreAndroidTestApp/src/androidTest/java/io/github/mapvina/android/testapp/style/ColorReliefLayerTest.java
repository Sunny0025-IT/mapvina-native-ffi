...
import io.github.mapvina.android.maps.BaseLayerTest;
...
import static io.github.mapvina.android.style.expressions.Expression.*;
import static org.junit.Assert.*;
import static io.github.mapvina.android.style.layers.Property.*;
import static io.github.mapvina.android.style.layers.PropertyFactory.*;
...
/**
 * Basic smoke tests for ColorReliefLayer
 */
@RunWith(AndroidJUnit4ClassRunner.class)
public class ColorReliefLayerTest extends BaseLayerTest {

  private ColorReliefLayer layer;
  ...
  public void beforeTest(){
    super.before();
    layer = new ColorReliefLayer("my-layer", "composite");
  ...
  @Test
  @UiThreadTest
  public void testColorReliefOpacityTransition() {
    Timber.i("color-relief-opacityTransitionOptions");
    assertNotNull(layer);

    // Set and Get
    TransitionOptions options = new TransitionOptions(300, 100);
    layer.setColorReliefOpacityTransition(options);
    assertEquals(layer.getColorReliefOpacityTransition(), options);
  }

  @Test
  @UiThreadTest
  public void testColorReliefOpacityAsConstant() {
    Timber.i("color-relief-opacity");
    assertNotNull(layer);
    assertNull(layer.getColorReliefOpacity().getValue());
