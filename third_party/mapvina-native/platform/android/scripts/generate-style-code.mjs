...
const lightJava = ejs.compile(fs.readFileSync(absPath('MapLibreAndroid/src/main/java/io/github/mapvina/android/style/light/light.java.ejs'), 'utf8'), {strict: true});
const lightJavaUnitTests = ejs.compile(fs.readFileSync(absPath('MapLibreAndroidTestApp/src/androidTest/java/io/github/mapvina/android/testapp/style/light.junit.ejs'), 'utf8'), {strict: true});
writeIfModified(absPath(`MapLibreAndroid/src/main/java/io/github/mapvina/android/style/light/Light.java`), lightJava({properties: lightProperties}));
writeIfModified(absPath(`MapLibreAndroidTestApp/src/androidTest/java/io/github/mapvina/android/testapp/style/LightTest.java`), lightJavaUnitTests({properties: lightProperties}));

// Java
const layerJava = ejs.compile(fs.readFileSync(absPath('MapLibreAndroid/src/main/java/io/github/mapvina/android/style/layers/layer.java.ejs'), 'utf8'), {strict: true});
const layerJavaUnitTests = ejs.compile(fs.readFileSync(absPath('MapLibreAndroidTestApp/src/androidTest/java/io/github/mapvina/android/testapp/style/layer.junit.ejs'), 'utf8'), {strict: true});

for (const layer of layers) {
  var srcDir = 'MapLibreAndroid/src/main/java/io/github/mapvina/android/style/layers/'
  var testDir = 'MapLibreAndroidTestApp/src/androidTest/java/io/github/mapvina/android/testapp/style/'
  if (layer.type === 'location-indicator') {
    srcDir = 'MapLibreAndroid/src/main/java/io/github/mapvina/android/location/'
    testDir = 'MapLibreAndroidTestApp/src/androidTest/java/io/github/mapvina/android/location/'
  }
...
const propertyFactoryTemplate = ejs.compile(fs.readFileSync(absPath('MapLibreAndroid/src/main/java/io/github/mapvina/android/style/layers/property_factory.java.ejs'), 'utf8'), {strict: true});

const propertyFactorySrcDir = absPath('MapLibreAndroid/src/main/java/io/github/mapvina/android/style/layers/PropertyFactory.java')
writeIfModified(
...
const locationPropertyFactorySrcDir = absPath('MapLibreAndroid/src/main/java/io/github/mapvina/android/location/LocationPropertyFactory.java')
writeIfModified(
...
// Java Property
const enumPropertyJavaTemplate = ejs.compile(fs.readFileSync(absPath('MapLibreAndroid/src/main/java/io/github/mapvina/android/style/layers/property.java.ejs'), 'utf8'), {strict: true});
writeIfModified(
    absPath(`MapLibreAndroid/src/main/java/io/github/mapvina/android/style/layers/Property.java`),
