package io.github.mapvina.android.constants;
...
public class MapLibreConstants {
   ...
   *
   * @deprecated unused, see {@link io.github.mapvina.android.maps.UiSettings#setDisableRotateWhenScaling(boolean)}
   */
  @Deprecated
   ...
   */
  public static final String LAYER_ID_ANNOTATIONS = "io.github.mapvina.annotations.points";
