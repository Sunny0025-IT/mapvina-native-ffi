...
import io.github.mapvina.android.camera.CameraPosition.Builder
import io.github.mapvina.android.camera.CameraUpdateFactory.CameraPositionUpdate
import io.github.mapvina.android.camera.CameraUpdateFactory.ZoomUpdate
    ...
    companion object {
        ...
        val CREATOR: Parcelable.Creator<CameraPosition> = object : Parcelable.Creator<CameraPosition> {
            override fun createFromParcel(parcel: Parcel): CameraPosition {
                ...
                // https://github.io/github/mapvina/maplibre-native/issues/1276
