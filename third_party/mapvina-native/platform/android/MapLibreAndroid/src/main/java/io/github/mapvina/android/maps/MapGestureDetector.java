...
import io.github.mapvina.android.constants.MapLibreConstants;
import io.github.mapvina.android.log.Logger;
import io.github.mapvina.android.utils.MathUtils;
...
import static io.github.mapvina.android.constants.MapLibreConstants.MAXIMUM_ANGULAR_VELOCITY;
import static io.github.mapvina.android.constants.MapLibreConstants.MAX_ABSOLUTE_SCALE_VELOCITY_CHANGE;
import static io.github.mapvina.android.constants.MapLibreConstants.QUICK_ZOOM_MAX_ZOOM_CHANGE;
import static io.github.mapvina.android.constants.MapLibreConstants.ROTATE_VELOCITY_RATIO_THRESHOLD;
import static io.github.mapvina.android.constants.MapLibreConstants.SCALE_VELOCITY_ANIMATION_DURATION_MULTIPLIER;
import static io.github.mapvina.android.constants.MapLibreConstants.SCALE_VELOCITY_RATIO_THRESHOLD;
import static io.github.mapvina.android.constants.MapLibreConstants.ZOOM_RATE;
import static io.github.mapvina.android.maps.MapLibreMap.OnCameraMoveStartedListener.REASON_API_GESTURE;
import static io.github.mapvina.android.utils.MathUtils.normalize;
    ...
    if (attachDefaultListeners) {
      StandardGestureListener standardGestureListener = new StandardGestureListener(
        context.getResources().getDimension(
          io.github.mapvina.android.gestures.R.dimen.mapbox_defaultScaleSpanSinceStartThreshold));
