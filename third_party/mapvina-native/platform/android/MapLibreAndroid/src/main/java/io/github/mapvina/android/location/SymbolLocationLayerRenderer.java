...
import static io.github.mapvina.android.location.LocationComponentConstants.ACCURACY_LAYER;
import static io.github.mapvina.android.location.LocationComponentConstants.BACKGROUND_ICON;
import static io.github.mapvina.android.location.LocationComponentConstants.BACKGROUND_LAYER;
import static io.github.mapvina.android.location.LocationComponentConstants.BACKGROUND_STALE_ICON;
import static io.github.mapvina.android.location.LocationComponentConstants.BEARING_ICON;
import static io.github.mapvina.android.location.LocationComponentConstants.BEARING_LAYER;
import static io.github.mapvina.android.location.LocationComponentConstants.FOREGROUND_ICON;
import static io.github.mapvina.android.location.LocationComponentConstants.FOREGROUND_LAYER;
import static io.github.mapvina.android.location.LocationComponentConstants.FOREGROUND_STALE_ICON;
import static io.github.mapvina.android.location.LocationComponentConstants.LOCATION_SOURCE;
import static io.github.mapvina.android.location.LocationComponentConstants.PROPERTY_ACCURACY_ALPHA;
import static io.github.mapvina.android.location.LocationComponentConstants.PROPERTY_ACCURACY_COLOR;
import static io.github.mapvina.android.location.LocationComponentConstants.PROPERTY_ACCURACY_RADIUS;
import static io.github.mapvina.android.location.LocationComponentConstants.PROPERTY_BACKGROUND_ICON;
import static io.github.mapvina.android.location.LocationComponentConstants.PROPERTY_BACKGROUND_STALE_ICON;
import static io.github.mapvina.android.location.LocationComponentConstants.PROPERTY_BEARING_ICON;
import static io.github.mapvina.android.location.LocationComponentConstants.PROPERTY_COMPASS_BEARING;
import static io.github.mapvina.android.location.LocationComponentConstants.PROPERTY_FOREGROUND_ICON;
import static io.github.mapvina.android.location.LocationComponentConstants.PROPERTY_FOREGROUND_ICON_OFFSET;
import static io.github.mapvina.android.location.LocationComponentConstants.PROPERTY_FOREGROUND_STALE_ICON;
import static io.github.mapvina.android.location.LocationComponentConstants.PROPERTY_GPS_BEARING;
import static io.github.mapvina.android.location.LocationComponentConstants.PROPERTY_LOCATION_STALE;
import static io.github.mapvina.android.location.LocationComponentConstants.PROPERTY_PULSING_OPACITY;
import static io.github.mapvina.android.location.LocationComponentConstants.PROPERTY_PULSING_RADIUS;
import static io.github.mapvina.android.location.LocationComponentConstants.PROPERTY_SHADOW_ICON_OFFSET;
import static io.github.mapvina.android.location.LocationComponentConstants.PULSING_CIRCLE_LAYER;
import static io.github.mapvina.android.location.LocationComponentConstants.SHADOW_ICON;
import static io.github.mapvina.android.location.LocationComponentConstants.SHADOW_LAYER;
import static io.github.mapvina.android.style.expressions.Expression.get;
...
import static io.github.mapvina.android.style.layers.PropertyFactory.circleColor;
import static io.github.mapvina.android.style.layers.PropertyFactory.circleOpacity;
import static io.github.mapvina.android.style.layers.PropertyFactory.circleRadius;
import static io.github.mapvina.android.style.layers.PropertyFactory.circleStrokeColor;
import static io.github.mapvina.android.style.layers.PropertyFactory.iconSize;
import static io.github.mapvina.android.style.layers.PropertyFactory.visibility;
import static io.github.mapvina.android.utils.ColorUtils.colorToRgbaString;
...
final class SymbolLocationLayerRenderer implements LocationLayerRenderer {
  ...
  private void refreshSource() {
    ...
    // https://github.io/github/mapvina/maplibre-native/issues/3348
    if (!style.isFullyLoaded()) {
      return;
    }
