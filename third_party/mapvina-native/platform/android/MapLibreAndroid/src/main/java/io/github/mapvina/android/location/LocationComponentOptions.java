...
public class LocationComponentOptions implements Parcelable {
   ...
   * the first parameter of {@link io.github.mapvina.android.maps.Style.Builder#addImage(String, Bitmap)}, the
   ...
   * and the custom {@link io.github.mapvina.android.gestures.AndroidGesturesManager} that was set with
   ...
   * {@link io.github.mapvina.android.maps.Style#addLayerAbove(Layer, String)}.
   * <p>
  ...
  /**
   * Gets the id of the layer that's referenced when placing the component on the map using
   * {@link io.github.mapvina.android.maps.Style#addLayerBelow(Layer, String)}.
   * <p>
  ...
  public static class Builder {
     ...
     * @deprecated Use
     * {@link io.github.mapvina.android.camera.CameraPosition.Builder#padding(double, double, double, double)} or
     * {@link io.github.mapvina.android.camera.CameraUpdateFactory#paddingTo(double, double, double, double)}
     * instead.
     */
    @NonNull
    @Deprecated
