...
dokka {
    ...
    dokkaSourceSets {
        configureEach {
            ...
            sourceLink {
                remoteUrl.set(uri("https://github.io/github/mapvina/maplibre-native/tree/main/platform/android/"))
                localDirectory.set(rootDir)
            }

            // TODO add externalDocumentationLinks when these get dokka or javadocs:
            // - https://github.io/github/mapvina/maplibre-java
            // - https://github.io/github/mapvina/maplibre-gestures-android
        }
    }
}
