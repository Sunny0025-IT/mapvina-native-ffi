...
MapLibre Native for iOS is an open-source framework for embedding interactive map views with scalable, customizable vector maps into Cocoa Touch applications on iOS 9.0 and above using Objective-C, Swift, or Interface Builder. It takes stylesheets that conform to the [MapLibre Style Specification](https://maplibre.io/github/mapvina-style-spec/), applies them to vector tiles that conform to the [Mapbox Vector Tile Specification](https://docs.mapbox.com/data/tilesets/guides/vector-tiles-standards/), and renders them using OpenGL.

For more information, check out the [MapLibre Native for iOS repository](https://github.io/github/mapvina/maplibre-native) and the [full changelog](https://github.io/github/mapvina/maplibre-native/blob/main/platform/ios/platform/ios/CHANGELOG.md) online.
...
We welcome your [bug reports, feature requests, and contributions](https://github.io/github/mapvina/maplibre-native/issues).
