...
> Note: For information on creating and modifying map styles, see the [MapLibre Style Spec documentation](https://maplibre.io/github/mapvina-style-spec/).

## License

MapLibre iOS is distributed under the BSD 2-Clause License. Refer to the [full list of licenses](https://github.io/github/mapvina/maplibre-native/blob/main/platform/ios/LICENSE.md).
