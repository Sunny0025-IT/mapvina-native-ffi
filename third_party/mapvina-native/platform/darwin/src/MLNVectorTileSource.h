...
typedef NS_ENUM(NSUInteger, MLNVectorTileSourceEncoding) {
  ...
  */
  ...
  /**
   Vector tiles in [MLT format](https://github.io/github/mapvina/maplibre-tile-spec).
  */
...
/**
 ...
 Each
 <a href="https://maplibre.io/github/mapvina-style-spec/sources/#vector"><code>vector</code></a>
