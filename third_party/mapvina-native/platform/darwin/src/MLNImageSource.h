...
/**
 ...
 Each
 <a href="https://maplibre.io/github/mapvina-style-spec/#sources-image"><code>image</code></a>
 ...
 "https://maplibre.io/github/mapvina-gl-js-docs/assets/radar.gif")!) mapView.style?.addSource(source)
 ```
