...
- (void)testUnsupportedFilterPredicates {
  XCTAssertThrowsSpecificNamed([NSPredicate predicateWithFormat:@"a BEGINSWITH 'L'"].mgl_filter,
                               NSException, NSInvalidArgumentException);
  XCTAssertThrowsSpecificNamed([NSPredicate predicateWithFormat:@"a ENDSWITH 'itude'"].mgl_filter,
                               NSException, NSInvalidArgumentException);
  XCTAssertThrowsSpecificNamed(
      [NSPredicate predicateWithFormat:@"a LIKE 'glob?trotter'"].mgl_filter, NSException,
      NSInvalidArgumentException);
  XCTAssertThrowsSpecificNamed(
      [NSPredicate predicateWithFormat:@"a MATCHES 'i\\w{18}n'"].mgl_filter, NSException,
      NSInvalidArgumentException);
  NSPredicate *selectorPredicate =
      [NSPredicate predicateWithFormat:@"(SELF isKindOfClass: %@)", [MLNPolyline class]];
  XCTAssertThrowsSpecificNamed(selectorPredicate.mgl_filter, NSException,
                               NSInvalidArgumentException);
...
- (void)testComparisonPredicates {
  ...
  }
  {
    NSPredicate *predicate =
        [NSPredicate predicateWithFormat:@"CAST(a, 'NSString') BETWEEN {'b', 'z'}"];
    NSArray *jsonExpression = @[
      @"all", @[ @"<=", @"b", @[ @"to-string", @[ @"get", @"a" ] ] ],
      @[ @"<=", @[ @"to-string", @[ @"get", @"a" ] ], @"z" ]
    ];
    XCTAssertEqualObjects(predicate.mgl_jsonExpressionObject, jsonExpression);
    XCTAssertEqualObjects([NSPredicate predicateWithMLNJSONObject:jsonExpression], predicate);
  ...
  {
    NSExpression *limits = [NSExpression expressionForAggregate:@[
      [NSExpression expressionForConstantValue:@10], [NSExpression expressionForConstantValue:@100]
    ]];
    NSPredicate *predicate =
        [NSPredicate predicateWithFormat:@"CAST(x, 'NSNumber') BETWEEN %@", limits];
    NSArray *jsonExpression = @[
      @"all", @[ @">=", @[ @"to-number", @[ @"get", @"x" ] ], @10 ],
      @[ @"<=", @[ @"to-number", @[ @"get", @"x" ] ], @100 ]
    ];
    XCTAssertEqualObjects([NSPredicate predicateWithMLNJSONObject:jsonExpression], predicate);
    [self testSymmetryWithPredicate:[NSPredicate predicateWithMLNJSONObject:jsonExpression]
  ...
  }
  {
    ...
    NSPredicate *predicate =
        [NSPredicate predicateWithFormat:@"$featureIdentifier IN { 6, 5, 4, 3}"];
    XCTAssertEqualObjects(predicate.mgl_jsonExpressionObject, expected);
    XCTAssertEqualObjects([NSPredicate predicateWithMLNJSONObject:expected], predicate);
    [self testSymmetryWithPredicate:[NSPredicate predicateWithMLNJSONObject:expected]
                      mustRoundTrip:YES];
  }
  {
    NSArray *expected = @[
      @"in", @[ @"to-number", @[ @"id" ] ],
      @[ @"literal", @[ @3002970001, @3004140052, @3002950027, @3002970033 ] ]
    ];
    NSPredicate *predicate =
        [NSPredicate predicateWithFormat:@"CAST($featureIdentifier, 'NSNumber') IN { 3002970001, "
                                         @"3004140052, 3002950027, 3002970033 }"];
    XCTAssertEqualObjects(predicate.mgl_jsonExpressionObject, expected);
    XCTAssertEqualObjects([NSPredicate predicateWithMLNJSONObject:expected], predicate);
    [self testSymmetryWithPredicate:[NSPredicate predicateWithMLNJSONObject:expected]
                      mustRoundTrip:YES];
  ...
  }
  {
    ...
    NSPredicate *predicate = [NSPredicate
        predicateWithFormat:@"%@ IN %@", [NSExpression expressionForVariable:@"geometryType"],
                            @[ @"LineString", @"Polygon" ]];
    XCTAssertEqualObjects(predicate.mgl_jsonExpressionObject, expected);
    NSPredicate *predicateAfter =
        [NSPredicate predicateWithFormat:@"%@ IN {'LineString', 'Polygon'}",
                                         [NSExpression expressionForVariable:@"geometryType"]];
  ...
  }
  {
    NSArray *expected =
        @[ @"in", @[ @"geometry-type" ], @[ @"literal", @[ @"LineString", @"Polygon" ] ] ];
    NSPredicate *predicate =
        [NSPredicate predicateWithFormat:@"%@ CONTAINS %@", @[ @"LineString", @"Polygon" ],
                                         [NSExpression expressionForVariable:@"geometryType"]];
    XCTAssertEqualObjects(predicate.mgl_jsonExpressionObject, expected);
    NSPredicate *predicateAfter =
        [NSPredicate predicateWithFormat:@"%@ IN {'LineString', 'Polygon'}",
  ...
  }
  {
    NSArray *expected = @[ @"in", @[ @"id" ], @[ @"literal", @[ @6, @5, @4, @3 ] ] ];
    NSPredicate *predicate =
        [NSPredicate predicateWithFormat:@"{ 6, 5, 4, 3} CONTAINS $featureIdentifier"];
    XCTAssertEqualObjects(predicate.mgl_jsonExpressionObject, expected);
    NSPredicate *predicateAfter =
        [NSPredicate predicateWithFormat:@"$featureIdentifier IN {6, 5, 4, 3}"];
    XCTAssertEqualObjects([NSPredicate predicateWithMLNJSONObject:expected], predicateAfter);
  ...
  }
  {
    ...
    XCTAssertEqualObjects(predicate.mgl_jsonExpressionObject, expected);
    XCTAssertEqualObjects([NSPredicate predicateWithMLNJSONObject:expected], predicate);
    XCTAssertEqualObjects([NSPredicate mgl_predicateWithFilter:predicate.mgl_filter],
  ...
  }
  {
    NSArray *expected = @[ @"in", @[ @"id" ], @[ @"literal", @[ @6, @5, @4, @3 ] ] ];
    NSPredicate *predicate =
        [NSPredicate predicateWithFormat:@"ANY {6, 5, 4, 3} = $featureIdentifier"];
    XCTAssertEqualObjects(predicate.mgl_jsonExpressionObject, expected);
    NSPredicate *predicateAfter =
        [NSPredicate predicateWithFormat:@"$featureIdentifier IN {6, 5, 4, 3}"];
    XCTAssertEqualObjects([NSPredicate predicateWithMLNJSONObject:expected], predicateAfter);
  ...
  }
  {
    NSArray *expected = @[ @"!", @[ @"in", @[ @"id" ], @[ @"literal", @[ @6, @5, @4, @3 ] ] ] ];
    NSPredicate *predicate =
        [NSPredicate predicateWithFormat:@"NONE {6, 5, 4, 3} = $featureIdentifier"];
    XCTAssertEqualObjects(predicate.mgl_jsonExpressionObject, expected);
    NSPredicate *predicateAfter =
        [NSPredicate predicateWithFormat:@"NOT $featureIdentifier IN {6, 5, 4, 3}"];
    XCTAssertEqualObjects([NSPredicate predicateWithMLNJSONObject:expected], predicateAfter);
    [self testSymmetryWithPredicate:[NSPredicate predicateWithMLNJSONObject:expected]
                      mustRoundTrip:YES];
  }
  {
    NSArray *expected = @[ @"!", @[ @"in", @[ @"id" ], @[ @"literal", @[ @6, @5, @4, @3 ] ] ] ];
    NSPredicate *predicate =
        [NSPredicate predicateWithFormat:@"ALL {6, 5, 4, 3} != $featureIdentifier"];
    XCTAssertEqualObjects(predicate.mgl_jsonExpressionObject, expected);
    NSPredicate *predicateAfter =
        [NSPredicate predicateWithFormat:@"NOT $featureIdentifier IN {6, 5, 4, 3}"];
    XCTAssertEqualObjects([NSPredicate predicateWithMLNJSONObject:expected], predicateAfter);
  ...
  }
  {
    NSPredicate *predicate =
        [NSPredicate predicateWithFormat:@"ANY {6, 5, 4, 3} != $featureIdentifier"];
    XCTAssertThrowsSpecificNamed(predicate.mgl_jsonExpressionObject, NSException,
                                 NSInvalidArgumentException);
  }
  {
    NSPredicate *predicate =
  ...
  }
  {
    ...
    MLNPolygon *shape =
        [MLNPolygon polygonWithCoordinates:coordinates
  ...
  }
  {
    ...
    MLNPolygonFeature *feature =
        [MLNPolygonFeature polygonWithCoordinates:coordinates
                                            count:sizeof(coordinates) / sizeof(coordinates[0])];
...
- (void)testComparisonPredicatesWithOptions {
  ...
  {
    NSPredicate *predicate = [NSPredicate
        predicateWithFormat:@"TRUE = MLN_FUNCTION('==', a, 'b', MLN_FUNCTION('collator', %@))", @{
          @"case-sensitive" : @NO,
          @"diacritic-sensitive" : @NO,
          @"locale" : @"tlh",
        }];
  ...
  {
    NSPredicate *predicate =
        [NSPredicate predicateWithFormat:@"ANY {6, 5, 4, 3} =[c] $featureIdentifier"];
    XCTAssertThrowsSpecificNamed(predicate.mgl_jsonExpressionObject, NSException,
                                 NSInvalidArgumentException);
  }
  {
    NSPredicate *predicate =
        [NSPredicate predicateWithFormat:@"NONE {6, 5, 4, 3} =[d] $featureIdentifier"];
    XCTAssertThrowsSpecificNamed(predicate.mgl_jsonExpressionObject, NSException,
                                 NSInvalidArgumentException);
  }
  {
    NSPredicate *predicate =
        [NSPredicate predicateWithFormat:@"ALL {6, 5, 4, 3} !=[cd] $featureIdentifier"];
    XCTAssertThrowsSpecificNamed(predicate.mgl_jsonExpressionObject, NSException,
                                 NSInvalidArgumentException);
  }
}
...
- (void)testSymmetryWithPredicate:(NSPredicate *)forwardPredicate
                    mustRoundTrip:(BOOL)mustRoundTrip {
  ...
  if (mustRoundTrip) {
    ...
    XCTAssertEqualObjects(forwardPredicate.predicateFormat.stringByRemovingPointerAddresses,
                          forwardPredicateAfter.predicateFormat.stringByRemovingPointerAddresses);
  } else {
