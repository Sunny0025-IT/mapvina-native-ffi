...
- `expression-test` contains tests for the expression feature in the map style (see more details about expression [here](https://maplibre.io/github/mapvina-style-spec/expressions/).
...
The "Style" component of MapLibre Native contains an implementation of the [MapLibre Style Spec](https://maplibre.io/github/mapvina-style-spec/), defining what data to draw, the order to draw it in, and how to style the data when drawing it.
