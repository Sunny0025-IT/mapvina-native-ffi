...
2. Once the PR is merged, the [`android-release.yml`](https://github.io/github/mapvina/maplibre-native/blob/main/.github/workflows/android-release.yml) workflow will run automatically to make the release.
