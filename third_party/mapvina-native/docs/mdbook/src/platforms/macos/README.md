...
> [!NOTE]
> There are some [AppKit](https://developer.apple.com/documentation/appkit) APIs for macOS the source tree. However those are not actively maintained. There is an [discussion](https://github.io/github/mapvina/maplibre-native/discussions/3414) on whether we should remove this code.
