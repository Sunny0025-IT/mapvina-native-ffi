...
bitflags::bitflags! {
    /// Mask of log severities that MapVina Native may dispatch asynchronously.
    #[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
...
bitflags::bitflags! {
    /// MapVina debug overlay mask bits.
    #[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
...
/// Severity for a MapVina Native log record.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[non_exhaustive]
...
/// Category for a MapVina Native log record.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[non_exhaustive]
pub enum LogEvent {
    General,
...
/// Resource loading method requested by MapVina Native.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[non_exhaustive]
...
/// Process-global network reachability state used by MapVina Native.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
#[non_exhaustive]
