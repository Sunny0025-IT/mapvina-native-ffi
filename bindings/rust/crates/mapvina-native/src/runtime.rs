...
use mapvina_core::AmbientCacheOperation;
...
pub use mapvina_core::runtime::{OfflineRegionDefinition, OfflineRegionInfo, RuntimeOptions};
pub(crate) use mapvina_core::runtime::{
...
impl RuntimeState {
    ...
    fn clear_resource_transform(&self) -> Result<()> {
        ...
        mapvina_core::check(unsafe { sys::mln_runtime_clear_resource_transform(runtime) })?;
        self.resource_transform.borrow_mut().take();
        Ok(())
    }
...
/// Owner-thread runtime handle for MapVina Native work and event polling.
...
impl RuntimeHandle {
    ...
    pub fn new() -> Result<Self> {
        mapvina_core::validate_abi_version()?;
    ...
    fn create_with_native_options_after_abi_validation(
        ...
        let mut out = mapvina_core::ptr::OutPtr::<sys::mln_runtime>::new();
        ...
        // this call.
        mapvina_core::check(unsafe { sys::mln_runtime_create(options, out.as_mut_ptr()) })?;
    ...
    /// and do not call MapVina Native APIs from it. Returning `Some(url)`
    ...
    pub fn create_offline_region(
        ...
        let mut out = mapvina_core::ptr::OutPtr::<sys::mln_offline_region_snapshot>::new();
        ...
        mapvina_core::check(unsafe {
            sys::mln_runtime_offline_region_create(
                runtime,
                &raw_definition,
                mapvina_core::runtime::metadata_ptr(metadata),
                metadata.len(),
                out.as_mut_ptr(),
            )
        })?;
        ...
        unsafe {
            mapvina_core::runtime::copy_offline_region_snapshot(
    ...
    pub fn offline_regions(&self) -> Result<Vec<OfflineRegionInfo>> {
        let runtime = self.inner.as_ptr()?;
        let mut out = mapvina_core::ptr::OutPtr::<sys::mln_offline_region_list>::new();
        ...
        unsafe {
            mapvina_core::runtime::copy_offline_region_list(
    ...
    pub fn merge_offline_regions_database(&self, path: &str) -> Result<Vec<OfflineRegionInfo>> {
        let runtime = self.inner.as_ptr()?;
        let path = mapvina_core::string::c_string(path)?;
        let mut out = mapvina_core::ptr::OutPtr::<sys::mln_offline_region_list>::new();
    ...
    pub fn offline_region_status(&self, region_id: i64) -> Result<OfflineRegionStatus> {
        let runtime = self.inner.as_ptr()?;
        let mut raw = mapvina_core::events::empty_offline_region_status_native();
        ...
        Ok(mapvina_core::events::offline_region_status_from_native(
            raw,
        ))
    }
    ...
    pub fn delete_offline_region(&self, region_id: i64) -> Result<()> {
        let runtime = self.inner.as_ptr()?;
        // SAFETY: runtime is live and region_id is passed by value.
        mapvina_core::check(unsafe { sys::mln_runtime_offline_region_delete(runtime, region_id) })
    }
    ...
    pub fn run_once(&self) -> Result<()> {
        ...
        mapvina_core::check(unsafe { sys::mln_runtime_run_once(runtime) })
    }
...
mod tests {
    ...
    fn offline_region_merge_database_uses_real_c_abi() {
        let base = unique_temp_dir("mapvina-rust-offline-merge");
