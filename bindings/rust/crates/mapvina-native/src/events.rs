...
pub(crate) use mapvina_core::{OfflineRegionDownloadState, RuntimeEventType};
...
impl RuntimeEvent {
    pub(crate) fn from_native(
        ...
        let copied = unsafe { mapvina_core::events::runtime_event_from_native(raw) }?;
        Ok(Self {
...
pub(crate) fn empty_runtime_event() -> sys::mln_runtime_event {
    mapvina_core::events::empty_runtime_event()
}
