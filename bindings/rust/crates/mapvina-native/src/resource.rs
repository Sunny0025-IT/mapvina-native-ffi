...
impl ResourceProviderState {
    ...
    pub(crate) fn descriptor(&self) -> sys::mln_resource_provider {
        mapvina_core::resource::resource_provider_descriptor(
    ...
    fn invoke(
        ...
        let request =
            match unsafe { mapvina_core::resource::copy_resource_request(raw_request.as_ref()) } {
                Ok(request) => request,
...
impl ResourceTransformState {
    ...
    pub(crate) fn descriptor(&self) -> sys::mln_resource_transform {
        mapvina_core::resource::resource_transform_descriptor(
    ...
    fn invoke(
        ...
        let status = unsafe {
            mapvina_core::resource::initialize_resource_transform_response(out_response)
        };
        ...
        let request = match unsafe {
            mapvina_core::resource::copy_resource_transform_request(raw_kind, url)
        } {
            Ok(request) => request,
            Err(error) => return mapvina_core::resource::status_for_error(&error),
        };
