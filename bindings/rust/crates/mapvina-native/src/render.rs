...
pub use mapvina_core::{PremultipliedRgba8Image, TextureImageInfo};
...
/// object. Passing it to MapVina Native transfers no ownership and grants the
...
impl RenderTargetExtent {
    ...
    pub(crate) fn to_core(&self) -> mapvina_core::render::RenderTargetExtentFields {
        mapvina_core::render::RenderTargetExtentFields {
            width: self.width,
            height: self.height,
...
impl MetalContextDescriptor {
    ...
    pub(crate) fn to_core(&self) -> mapvina_core::render::MetalContextDescriptorFields {
        mapvina_core::render::MetalContextDescriptorFields {
...
impl VulkanContextDescriptor {
    ...
    pub(crate) fn to_core(&self) -> mapvina_core::render::VulkanContextDescriptorFields {
        mapvina_core::render::VulkanContextDescriptorFields {
...
impl MetalSurfaceDescriptor {
    ...
    pub(crate) fn to_native(&self) -> sys::mln_metal_surface_descriptor {
        mapvina_core::render::metal_surface_descriptor_to_native(
            mapvina_core::render::MetalSurfaceDescriptorFields {
...
impl VulkanSurfaceDescriptor {
    ...
    pub(crate) fn to_native(&self) -> sys::mln_vulkan_surface_descriptor {
        mapvina_core::render::vulkan_surface_descriptor_to_native(
            mapvina_core::render::VulkanSurfaceDescriptorFields {
                extent: self.extent.to_core(),
                context: self.context.to_core(),
...
impl MetalOwnedTextureDescriptor {
    ...
    pub(crate) fn to_native(&self) -> sys::mln_metal_owned_texture_descriptor {
        mapvina_core::render::metal_owned_texture_descriptor_to_native(
            mapvina_core::render::MetalOwnedTextureDescriptorFields {
                extent: self.extent.to_core(),
                context: self.context.to_core(),
            },
        )
...
impl MetalBorrowedTextureDescriptor {
    ...
    pub(crate) fn to_native(&self) -> sys::mln_metal_borrowed_texture_descriptor {
        mapvina_core::render::metal_borrowed_texture_descriptor_to_native(
            mapvina_core::render::MetalBorrowedTextureDescriptorFields {
                extent: self.extent.to_core(),
...
impl VulkanOwnedTextureDescriptor {
    ...
    pub(crate) fn to_native(&self) -> sys::mln_vulkan_owned_texture_descriptor {
        mapvina_core::render::vulkan_owned_texture_descriptor_to_native(
            mapvina_core::render::VulkanOwnedTextureDescriptorFields {
                extent: self.extent.to_core(),
                context: self.context.to_core(),
            },
        )
...
impl VulkanBorrowedTextureDescriptor {
    ...
    pub(crate) fn to_native(&self) -> sys::mln_vulkan_borrowed_texture_descriptor {
        mapvina_core::render::vulkan_borrowed_texture_descriptor_to_native(
            mapvina_core::render::VulkanBorrowedTextureDescriptorFields {
                extent: self.extent.to_core(),
                context: self.context.to_core(),
...
impl MetalOwnedTextureFrameHandle {
    ...
    pub fn close(self) -> std::result::Result<(), HandleOperationError<Self>> {
        ...
        if let Err(error) = mapvina_core::check(unsafe {
...
impl RenderSessionHandle {
        ...
        F: FnOnce(*mut sys::mln_map, *mut *mut sys::mln_render_session) -> sys::mln_status,
    {
        ...
        let mut out = mapvina_core::ptr::OutPtr::<sys::mln_render_session>::new();
        let status = attach(map_ptr, out.as_mut_ptr());
        mapvina_core::check(status)?;
    ...
    pub fn render_update(&self) -> Result<()> {
        ...
        let session = self.inner.as_ptr()?;
        // SAFETY: session is a live render session handle owned by this wrapper.
        mapvina_core::check(unsafe { sys::mln_render_session_render_update(session) })
    }
    ...
    pub fn detach(
        ...
        // SAFETY: session is a live render session handle owned by this wrapper.
        if let Err(error) = mapvina_core::check(unsafe { sys::mln_render_session_detach(session) })
        {
            return Err(HandleOperationError::new(error, self));
        }
    ...
    pub fn reduce_memory_use(&self) -> Result<()> {
        ...
        let session = self.inner.as_ptr()?;
        // SAFETY: session is a live render session handle owned by this wrapper.
        mapvina_core::check(unsafe { sys::mln_render_session_reduce_memory_use(session) })
    }
    ...
    pub fn clear_data(&self) -> Result<()> {
        ...
        let session = self.inner.as_ptr()?;
        // SAFETY: session is a live render session handle owned by this wrapper.
        mapvina_core::check(unsafe { sys::mln_render_session_clear_data(session) })
    }

    /// Dumps renderer debug logs through MapVina Native logging.
    pub fn dump_debug_logs(&self) -> Result<()> {
        self.inner.ensure_no_frame_acquired()?;
        let session = self.inner.as_ptr()?;
        // SAFETY: session is a live render session handle owned by this wrapper.
        mapvina_core::check(unsafe { sys::mln_render_session_dump_debug_logs(session) })
    }
    ...
    pub fn texture_image_info(&self) -> Result<TextureImageInfo> {
        ...
        {
            Ok(mapvina_core::values::texture_image_info_from_native(&info))
        } else {
