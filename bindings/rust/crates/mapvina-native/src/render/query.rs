...
pub(crate) use mapvina_core::query::{
...
impl super::RenderSessionHandle {
    ...
    pub fn query_rendered_features(
        ...
        let options = options
            ...
            .transpose()?;
        let mut out = mapvina_core::ptr::OutPtr::<sys::mln_feature_query_result>::new();
        ...
        unsafe {
            mapvina_core::query::copy_feature_query_result(
    ...
    pub fn query_feature_extension(
        ...
        let session = self.inner.as_ptr()?;
        let source_id = mapvina_core::string::string_view(source_id);
        let extension = mapvina_core::string::string_view(extension);
        let extension_field = mapvina_core::string::string_view(extension_field);
        ...
        let mut out = mapvina_core::ptr::OutPtr::<sys::mln_feature_extension_result>::new();
        ...
        unsafe {
            mapvina_core::query::copy_feature_extension_result(
