package io.github.mapvina.nativeffi.test;
...
public final class RenderTargetTestSupport implements AutoCloseable {
  ...
  public static RenderTargetTestSupport attachOwnedTexture(
    ...
    var backends = Mapvina.supportedRenderBackends();
      ...
      try (var stack = MemoryStack.stackPush()) {
        ...
        var app =
            VkApplicationInfo.calloc(stack)
                ...
                .pApplicationName(stack.UTF8("mapvina-native-java-tests"))
                .pEngineName(stack.UTF8("mapvina-native-ffi"))
