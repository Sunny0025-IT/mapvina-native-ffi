...
import io.github.mapvina.nativeffi.internal.c.mln_resource_transform;
import io.github.mapvina.nativeffi.internal.c.mln_resource_transform_callback;
import io.github.mapvina.nativeffi.internal.c.mln_resource_transform_response;
...
import io.github.mapvina.nativeffi.resource.ResourceTransformRequest;
...
public final class ResourceTransformState implements AutoCloseable {
  ...
  private int invoke(
    ...
    try {
      ...
      return MapVinaNativeC.MLN_STATUS_OK();
    } catch (IllegalArgumentException error) {
      return MapVinaNativeC.MLN_STATUS_INVALID_ARGUMENT();
    } catch (Throwable ignored) {
      return MapVinaNativeC.MLN_STATUS_NATIVE_ERROR();
    }
  }
