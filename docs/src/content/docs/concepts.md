---
title: Concepts
description: Core mental models for using MapVina Native FFI.
---

## Mental Model

MapVina Native FFI exposes MapVina Native concepts directly. Applications can
...
MapVina Native make progress and to collect completed work.
...
Events preserve MapVina Native's observer-driven model across the FFI boundary.
