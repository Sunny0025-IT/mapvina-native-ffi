...
The project exposes MapVina Native through two layers.

The C API exposes core MapVina Native features on supported native platforms:
...
Read the [Binding Conventions](/mapvina-native-ffi/development/bindings/)
...
The setup hooks install project dependencies and initialize the MapVina Native
submodule at `third_party/mapvina-native`.
