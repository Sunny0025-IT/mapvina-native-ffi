...
- Tracking issue:
  [#119](https://github.io/github/mapvina/mapvina-native-ffi/issues/119)
...
[Rust binding conventions](/mapvina-native-ffi/development/bindings-rust/). The
...
```vala
public errordomain MapVinaNative.Error {
    INVALID_ARGUMENT,
    INVALID_STATE,
    WRONG_THREAD,
    UNSUPPORTED,
