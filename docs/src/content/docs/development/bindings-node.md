...
- Tracking issue:
  [#50](https://github.io/github/mapvina/mapvina-native-ffi/issues/50)
...
by the
[Rust binding conventions](/mapvina-native-ffi/development/bindings-rust/).
...
Native callbacks from MapVina worker, network, logging, or render-related
...
configured from JavaScript, not a JavaScript callback on the MapVina network
thread.
