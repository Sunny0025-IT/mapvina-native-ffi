...
- Tracking issue:
  [#47](https://github.io/github/mapvina/mapvina-native-ffi/issues/47)
...
[Java FFM conventions](/mapvina-native-ffi/development/bindings-java-ffm/),
`androidMain` delegates to the
[Java JNI conventions](/mapvina-native-ffi/development/bindings-java-jni/), and
...
MapVina worker, network, logging, or render-related threads.
