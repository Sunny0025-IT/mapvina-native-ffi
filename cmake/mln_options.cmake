function(mln_configure_options)
  set(MLN_WITH_CORE_ONLY ON CACHE BOOL "Build only MapVina Native core" FORCE)
  set(MLN_WITH_GLFW OFF
      CACHE BOOL "Disable MapVina Native GLFW platform" FORCE)
  set(MLN_WITH_PMTILES ON
      CACHE BOOL "Build MapVina Native PMTiles support" FORCE)
  ...
  set(MLN_WITH_METAL OFF CACHE BOOL "Build MapVina Native Metal backend" FORCE)
  set(MLN_WITH_VULKAN OFF
      CACHE BOOL "Build MapVina Native Vulkan backend" FORCE)
  if(MLN_FFI_RENDER_BACKEND STREQUAL "metal")
    set(MLN_WITH_METAL ON
        CACHE BOOL "Build MapVina Native Metal backend" FORCE)
  ...
  set(MLN_WITH_WERROR OFF
      CACHE BOOL "Do not fail wrapper builds on MapVina Native warnings" FORCE)
  ...
  message(
    STATUS "Configuring mapvina-native-c ${MLN_FFI_RENDER_BACKEND} backend")
