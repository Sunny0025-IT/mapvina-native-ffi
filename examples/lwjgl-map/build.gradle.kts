...
application {
  mainClass = "io.github.mapvina.nativeffi.examples.lwjglmap.Main"
...
val nativeLibraryPath = nativeBuildDir.map { "$it/${System.mapLibraryName("mapvina-native-c")}" }

tasks.withType<JavaExec>().configureEach {
  jvmArgs(lwjglMapJvmArgs)
  systemProperty(nativeLibraryPathProperty, nativeLibraryPath.get())
  inputs.file(nativeLibraryPath).withPropertyName("mapvinaNativeCLibrary").optional()
}
