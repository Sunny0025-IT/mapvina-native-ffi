...
pub fn main(init_args: std.process.Init) !void {
    ...
    try mapvina.setLogCallback(.{ .handler = diagnostics.logRecord }, null);
    defer mapvina.clearLogCallback(null) catch {};
...
fn printUsage() void {
    std.debug.print(
        ...
        \\
        \\Modes:
        \\  owned-texture     MapVina-owned Metal/Vulkan texture APIs
