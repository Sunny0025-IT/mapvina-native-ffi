...
const VulkanOwnedTextureBackend = struct {
    ...
    pending_frame: ?mapvina.VulkanOwnedTextureFrameHandle,
    ...
    fn attachRenderTarget(
        ...
        const texture = mapvina.attachVulkanOwnedTexture(map, .{
...
const VulkanBorrowedTextureBackend = struct {
    ...
    fn attachRenderTarget(
        ...
        const texture = mapvina.attachVulkanBorrowedTexture(map, .{
            .extent = render_target.extent(viewport),
            .context = vulkanContextDescriptor(&self.compositor.context),
...
const VulkanSurfaceBackend = struct {
    ...
    fn attachRenderTarget(
        ...
        const surface = mapvina.attachVulkanSurface(map, .{
            .extent = render_target.extent(viewport),
...
fn vulkanContextDescriptor(context: *const Context) mapvina.VulkanContextDescriptor {
    return .{
