...
pub struct App {
    ...
    map: Option<mapvina_native::MapHandle>,
...
impl App {
    ...
    pub fn print_status(&self) {
        println!("MapVina Rust Vulkan map example running. Close the window to exit.");
...
fn configure_map(map: &mapvina_native::MapHandle) -> mapvina_native::Result<()> {
...
fn immediate_exit(code: i32) -> ! {
    ...
    // abort while MapVina native tears down thread-local state after the window
