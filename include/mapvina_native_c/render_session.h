/**
 * @file mapvina_native_c/render_session.h
 * Public C API declarations for render sessions.
 */

#ifndef MAPVINA_NATIVE_C_RENDER_SESSION_H
#define MAPVINA_NATIVE_C_RENDER_SESSION_H
...
/**
 * Dumps renderer debug logs for the session through MapVina Native logging.
 *
 * Returns:
 * - MLN_STATUS_OK on success.
 * - MLN_STATUS_INVALID_ARGUMENT when session is null or not live.
...
#endif  // MAPVINA_NATIVE_C_RENDER_SESSION_H
