/**
 * @file mapvina_native_c/camera.h
 * Public C API declarations for map camera and coordinate conversion.
 */

#ifndef MAPVINA_NATIVE_C_CAMERA_H
#define MAPVINA_NATIVE_C_CAMERA_H
...
/**
 * Applies MapVina debug overlay mask bits to a map.
 *
...
/**
 * Copies the current MapVina debug overlay mask bits.
 *
 * Returns:
 * - MLN_STATUS_OK on success.
...
/**
 * Copies whether MapVina's rendering stats overlay view is enabled.
 *
 * Returns:
 * - MLN_STATUS_OK on success.
...
/**
 * Copies whether MapVina currently considers the map fully loaded.
 *
 * Returns:
 * - MLN_STATUS_OK on success.
 ...
 * animation uses MapVina Native's default animation options.
 *
 * Returns:
 * - MLN_STATUS_OK on success.
 * - MLN_STATUS_INVALID_ARGUMENT when map is null or not live, camera is null,
 ...
 *
 * Passing a null animation uses MapVina Native's default animation options.
 *
 * Returns:
 * - MLN_STATUS_OK on success.
 ...
 *
 * Passing a null anchor uses MapVina Native's default zoom anchor.
 *
 * Returns:
 * - MLN_STATUS_OK on success.
 ...
 *
 * Passing a null anchor uses MapVina Native's default zoom anchor. Passing a
 * null animation uses MapVina Native's default animation options.
 *
 * Returns:
 * - MLN_STATUS_OK on success.
 * - MLN_STATUS_INVALID_ARGUMENT when map is null or not live, scale is
 ...
 *
 * Position uses MapVina Native's modified Web Mercator camera space.
 ...
 *
 * On success, *out_mode is overwritten. MapVina currently reports all fields.
 *
 * Returns:
 * - MLN_STATUS_OK on success.
...
#endif  // MAPVINA_NATIVE_C_CAMERA_H
