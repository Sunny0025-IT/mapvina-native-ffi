/**
 * @file mapvina_native_c/query.h
 * Public C API declarations for feature queries.
 */

#ifndef MAPVINA_NATIVE_C_QUERY_H
#define MAPVINA_NATIVE_C_QUERY_H
...
typedef struct mln_rendered_feature_query_options {
  ...
  /** Optional MapVina style-spec filter JSON. Null means no filter. */
...
#endif  // MAPVINA_NATIVE_C_QUERY_H
