/**
 * @file mapvina_native_c/render_target.h
 * Shared public C API declarations for render target descriptors.
 */

#ifndef MAPVINA_NATIVE_C_RENDER_TARGET_H
#define MAPVINA_NATIVE_C_RENDER_TARGET_H
...
#endif  // MAPVINA_NATIVE_C_RENDER_TARGET_H
