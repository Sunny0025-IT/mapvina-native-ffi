/**
 * @file mapvina_native_c/style.h
 * Public C API declarations for style sources, layers, and images.
 */

#ifndef MAPVINA_NATIVE_C_STYLE_H
#define MAPVINA_NATIVE_C_STYLE_H
 ...
 * function parses and copies the accepted source into MapVina Native before
 * return.
 *
 * Returns:
 * - MLN_STATUS_OK on success.
 ...
 * url through MapVina Native's resource system.
 *
 * Returns:
 * - MLN_STATUS_OK on success.
 ...
 * is copied into MapVina Native before return.
 *
 * Returns:
 * - MLN_STATUS_OK on success.
 * - MLN_STATUS_INVALID_ARGUMENT when map is null or not live, source_id is
 ...
 * accepted strings into MapVina Native before return. options may be null for
 * defaults.
 *
 * Returns:
 * - MLN_STATUS_OK on success.
 ...
 * copies accepted pixels into MapVina Native before return.
 *
 * Returns:
 * - MLN_STATUS_OK on success.
 * - MLN_STATUS_INVALID_ARGUMENT when map is null or not live, source_id is
 ...
 * function copies accepted coordinates into MapVina Native before return.
 *
 * Returns:
 * - MLN_STATUS_OK on success.
 * - MLN_STATUS_INVALID_ARGUMENT when map is null or not live, source_id is
 ...
 * accepted light into MapVina Native before return.
 *
 * Returns:
 * - MLN_STATUS_OK on success.
...
/**
 * Sets one style light property using its MapVina style-spec property name.
 *
 ...
 * MapVina Native's typed light property storage before return.
 *
 * Returns:
 * - MLN_STATUS_OK on success.
...
/**
 * Sets one layer property using its MapVina style-spec property name.
 *
 ...
 * arrays. The function parses and copies the accepted value into MapVina
 ...
 * the layer filter. Non-null filters use the MapVina style-spec filter JSON
 * representation. The function parses and copies the accepted filter into
 * MapVina Native's typed filter expression storage before return.
 *
 * Returns:
 * - MLN_STATUS_OK on success.
 * - MLN_STATUS_INVALID_ARGUMENT when map is null or not live, layer_id is
...
#endif  // MAPVINA_NATIVE_C_STYLE_H
