/**
 * @file mapvina_native_c/base.h
 * Public C API declarations for base ABI types and status values.
 */

#ifndef MAPVINA_NATIVE_C_BASE_H
#define MAPVINA_NATIVE_C_BASE_H
...
typedef enum mln_status : int32_t {
  ...
  /** A native MapVina error or C++ exception was converted to status. */
